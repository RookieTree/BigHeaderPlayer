package com.tree.bigheaderplayer.http;

/*
 *  @项目名：  BigHeaderPlayer 
 *  @包名：    com.tree.bigheaderplayer.http
 *  @文件名:   HeadApi
 *  @创建者:   Administrator
 *  @创建时间:  2018/4/21 16:30
 *  @描述：    TODO
 */

import com.tree.bigheaderplayer.bean.BannerData;
import com.tree.bigheaderplayer.bean.BaseResponse;
import com.tree.bigheaderplayer.bean.FeedArticleListData;
import com.tree.bigheaderplayer.bean.KnowledgeHierarchyData;
import com.tree.bigheaderplayer.bean.LoginData;
import com.tree.bigheaderplayer.bean.NavigationListData;
import com.tree.bigheaderplayer.bean.ProjectClassifyData;
import com.tree.bigheaderplayer.bean.ProjectListData;
import com.tree.bigheaderplayer.bean.TopSearchData;
import com.tree.bigheaderplayer.bean.UsefulSiteData;
